...
namespace GONet.Sample
{
    ...
    public class Projectile_ZeroSync : GONetParticipantCompanionBehaviour, IGONetSyncdBehaviourInitializer
    {
        ...
        internal override void UpdateAfterGONetReady()
        {
            ...
            {
                // Use IsLocallyResponsible for client-host/failover support:
                // - IsMine true: normal ownership destruction
                // - IsMine false but IsLocallyResponsible true: server cleanup of orphaned projectiles
                if (GONetParticipant.IsLocallyResponsible)
                {
