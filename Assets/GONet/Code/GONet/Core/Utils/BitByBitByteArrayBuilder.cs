...
namespace GONet.Utils
{
    ...
    public sealed class BitByBitByteArrayBuilder : IDisposable
    {
        ...
        public int BitsRemaining => isUsingBitWriterReader
            ? bitReader.BitsRemaining
            : (length_WrittenBytes * 8) - Position_Bits;
 ...
 */
    ...
    {
        #region Log Pattern Constants

        /// <summary>
        /// Log message pattern for float values exceeding reasonable physics bounds (±1,000,000).
        /// This constant serves as the "shared truth" between the producer (BitWriter) and
        /// the consumer (GONetLog suppression mechanism), ensuring pattern matching is exact.
        ///
        /// <para><b>Usage in Tests:</b></para>
        /// Unit tests that stress-test float serialization with extreme values can suppress
        /// this expected warning to prevent log bloat (200,000+ warnings = multi-gigabyte logs).
        ///
        ...
        /// </code>
        /// </summary>
        public const string LogPattern_FloatBounds = "[BitWriter] Float value exceeds reasonable bounds:";
        ...
        public unsafe void WriteFloat(float value)
        {
            ...
            {
                GONetLog.Warning($"{LogPattern_FloatBounds} {value}. This may indicate physics objects out of valid range. Clamping to ±1,000,000.");
