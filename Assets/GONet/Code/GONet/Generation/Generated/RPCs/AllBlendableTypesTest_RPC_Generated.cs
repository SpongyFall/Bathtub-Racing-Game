...
namespace GONet
{
    internal static class AllBlendableTypesTest_RpcIds
    {
        // Base class RPC IDs
        internal const uint GetFullRpcValidationReport_RpcId = 0xBCF6ED9A;
    }

    internal static class AllBlendableTypesTest_RpcInitializer
    {
        [UnityEngine.RuntimeInitializeOnLoadMethod(UnityEngine.RuntimeInitializeLoadType.BeforeSceneLoad)]
        private static void Initialize()
        {
            AllBlendableTypesTest_RpcDispatcher.EnsureInitialized();
        }
    }

    internal class AllBlendableTypesTest_RpcDispatcher : IRpcDispatcher
    {
        ...
        static AllBlendableTypesTest_RpcDispatcher()
        {
            if (!isInitialized)
            {
                isInitialized = true;
                GONetMain.EventBus.RegisterRpcIdMapping(0xBCF6ED9A, nameof(GONetParticipantCompanionBehaviour.GetFullRpcValidationReport), typeof(AllBlendableTypesTest));
                GONetMain.EventBus.RegisterRpcDispatcher(typeof(AllBlendableTypesTest), new AllBlendableTypesTest_RpcDispatcher());
                GONetMain.EventBus.RegisterRpcMetadata(typeof(AllBlendableTypesTest), Metadata);
                RegisterRpcHandlers();
                GONetLog.Debug("Initialized RPC dispatcher for AllBlendableTypesTest");
            }
        }
