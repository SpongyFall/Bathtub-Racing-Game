...
namespace GONet.Tests.Time
{
    ...
    /// </summary>
    [TestFixture]
    [Timeout(60000)] // 60 second timeout for all tests in this fixture - some tests have 5-11 second sleeps
    ...
    [TestFixture]
    [Timeout(90000)] // 90 second timeout - this test has a 30 second while loop plus thread setup/teardown
