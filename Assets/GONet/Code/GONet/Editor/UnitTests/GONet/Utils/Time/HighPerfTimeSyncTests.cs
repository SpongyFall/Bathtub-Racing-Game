...
namespace GONet.Tests.Time
{
    ...
    public class HighPerfTimeSyncTests : TimeSyncTestBase
    {
        ...
        public void ProcessTimeSync_Performance()
        {
            ...
            Assert.That(timePerCallUs, Is.LessThan(100)); // Increased from 50 to account for batch test execution overhead
        }
    ...
    /// </summary>
    [TestFixture]
    [Timeout(60000)] // 60 second timeout - one test has 12 second while loop
