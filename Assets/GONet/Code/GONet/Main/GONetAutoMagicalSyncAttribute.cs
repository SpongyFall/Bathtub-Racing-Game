...
namespace GONet
{
    ...
    public class GONetAutoMagicalSyncAttribute : Attribute
    {
        ...
        /// <summary>
        /// LEGACY: Generic animator controller parameters profile. Kept for backward compatibility.
        /// New code should use the type-specific profiles below.
        /// </summary>
        public const string PROFILE_TEMPLATE_NAME___ANIMATOR_CONTROLLER_PARAMETERS = "_GONet_Animator_Controller_Parameters";

        /// <summary>
        /// Profile for Float-type animator parameters.
        /// Float params represent continuous values (e.g., Vertical, Horizontal, Speed) that change smoothly over time.
        /// Uses: Unreliable transport (lower latency, packet loss acceptable since new values arrive frequently),
        ///       Blending/interpolation (smooths values on receiving end), Higher frequency updates (20Hz).
        /// </summary>
        public const string PROFILE_TEMPLATE_NAME___ANIMATOR_CONTROLLER_PARAMETERS_FLOAT = "_GONet_Animator_Controller_Parameters_Float";

        /// <summary>
        /// Profile for Int and Bool-type animator parameters.
        /// Int/Bool params represent discrete states (e.g., State, Mode, Grounded, IsJumping) that are either one value or another.
        /// Uses: Reliable transport (cannot miss state transitions - e.g., missing Grounded=false causes visual glitches),
        ///       Immediate application (no blending - you're either in State 1 or State 2, not State 1.5),
        ///       ASAP frequency (state changes should propagate immediately).
        /// </summary>
        public const string PROFILE_TEMPLATE_NAME___ANIMATOR_CONTROLLER_PARAMETERS_DISCRETE = "_GONet_Animator_Controller_Parameters_Discrete";
