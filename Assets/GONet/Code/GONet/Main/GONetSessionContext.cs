...
namespace GONet
{
    ...
    public class GONetSessionContext : MonoBehaviour
    {
        ...
        private void Start()
        {
            // IMPORTANT: This was moved from Awake to Start so it runs AFTER onSceneLoaded processes and this is recognized as a "design time GONetParticipant"...somehow moving into DDOL in Awake was too soon and it did not get categorized as design time
