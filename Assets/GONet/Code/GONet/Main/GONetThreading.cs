...
namespace GONet
{
    ...
    public static class GONetThreading
    {
        ...
        /// <summary>
        /// Resets threading state for a new session (Fast Iteration Mode support).
        /// Clears any pending callbacks and allows re-initialization.
        /// </summary>
        internal static void ResetForNewSession()
        {
            ...
            // Reset initialization flag - main thread ID should be the same
            // but reset anyway to ensure clean state
            isInitialized = false;
            mainThreadId = -1;
        }
